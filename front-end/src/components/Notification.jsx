...
const notificationConfig = {
  ...
  loading: {
    ...
    icon: <LoadingSpinner className="w-6 h-6" />,
    gradient:
...
const Notification = ({
  ...
  return (
    ...
    >
      ...
      {duration && (
        <div className="absolute bottom-0 left-0 w-full h-1 overflow-hidden bg-gray-300/50 dark:bg-gray-600/50 rounded-b-xl">
          <motion.div
            initial={{
              width: 0,
            }}
